...
class Game:
    ...
    def update_timer(self):
        self.clock_text = self.font.render(str(self.timer), True, (0, 0, 0))
        text_rect = self.clock_text.get_rect(center=self.bottom_screen_rect_obj.center)
        ...
        self.screen.blit(self.clock_text, text_rect)
